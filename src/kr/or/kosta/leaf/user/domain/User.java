package kr.or.kosta.leaf.user.domain;
...
public class User {
	...
	public User(int ctm_no, String ctm_name, String ctm_division, String ctm_id, String ctm_passwd, String ctm_regdate,
	...
	public String toString() {
		return "User [ctm_no=" + ctm_no + ", ctm_name=" + ctm_name + ", ctm_division=" + ctm_division + ", ctm_id="
