        ...
        <div id="content">
            ...
            <div class="container"  style="width:1000px; text-align: center; ">
                <div  style="width:1000px;  text-align: center; " >
                    <div id="main-slider">
                        <div class="item">
                            <a href="category.leaf"><img src="img/armani.png" alt="" class="img-responsive" width="1000px"></a>
                        </div>
                        <div class="item">
                            <a href="category.leaf"><img class="img-responsive" src="img/saint.PNG" alt="" width="1000px"></a>
                        </div>
                        <div class="item">
                            <a href="category.leaf"><img class="img-responsive" src="img/dlqtod.jpg" alt="" width="1000px"></a>
                        </div>
