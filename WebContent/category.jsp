...
<body>
 ...
 _________________________________________________________ -->
          <div class="panel panel-default sidebar-menu">
            ...
            <div class="panel-body">
              <ul class="nav nav-pills nav-stacked category-menu">
                <li><a href="category.leaf">Face <span
              ...
              <li class="active"><a href="category.leaf">Eye <span
        ...
        <div class="col-md-9">
          <div class="box">
            <h1>Ladies</h1>
            <p>In our Ladies department we offer wide selection of
              the best products we have found and carefully selected
              worldwide.</p>
          </div>
          ...
          <div class="box info-bar">
            <div class="row">
              <div class="col-sm-12 col-md-4 products-showing">
                Showing <strong>12</strong> of <strong>25</strong>
                products
              </div>
            ...
            <div class="col-md-4 col-sm-6">
              <div class="product">
                ...
                <a href="detail.leaf" class="invisible"> 
                  <img src="http://localhost/uploadphoto/${i.productImage}" alt="image" class="img-responsive">
                </a>
                <div class="text">
                  <h3>
                    <a href="detail.leaf">${i.productName}</a>
                  </h3>
          ...
          <div class="col-md-3 col-sm-6">
            ...
            <p class="social">
              ...
              <a href="#" class="instagram external"
                ...
                class="gplus external" data-animate-hover="shake"><i
