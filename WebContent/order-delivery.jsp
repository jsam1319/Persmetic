                    ...
                    <div class="box">
                        <form method="post" action="order-delivery.leaf">
                            ...
                            <ul class="nav nav-pills nav-justified">
                                <li><a href="order-address.leaf"><i class="fa fa-map-marker"></i><br>ì£¼ììë ¥</a>
                                </li>
                                <li class="active"><a href="#"><i class="fa fa-money"></i><br>ê²°ì ë°©ì</a>
                                </li>
                            </ul>
                            ...
                            <div class="box-footer">
                                <div class="pull-left">
                                    <a href="basket.leaf" class="btn btn-default"><i class="fa fa-chevron-left"></i>ë¤ë¡ ê°ê¸°</a>
                                </div>
                                <div class="pull-right">
                                    <button type="submit" class="btn btn-primary">ê²°ì íê¸°<i class="fa fa-chevron-right"></i>
                                    </button>
                                </div>
                            </div>
                        </form>
